# backend/api/management/commands/scrape_mlb_futures.py
...
import time
from api.models import MLBFutures
import logging
import json

class Command(BaseCommand):
    help = 'Scrape MLB futures data from ESPNBet'
