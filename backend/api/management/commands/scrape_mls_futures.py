# backend/api/management/commands/scrape_mls_futures.py
...
import time
from api.models import MLSFutures
import logging
import json

class Command(BaseCommand):
    help = 'Scrape MLS futures data from ESPNBet'
    ...
    def handle(self, *args, **kwargs):
        ...
        # Clear the existing MLS Futures in the database
        MLSFutures.objects.all().delete()
        ...
        # URL to scrape
        url = "https://espnbet.com/sport/soccer/organization/usa/competition/mls/section/futures"
        driver.get(url)
