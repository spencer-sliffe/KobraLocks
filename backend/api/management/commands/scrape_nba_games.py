# backend/api/management/commands/scrape_nba_games.py
...
import time
from api.models import NBAGame
import datetime
import pytz
import logging

class Command(BaseCommand):
    help = 'Scrape NBA games data from ESPNBet'
    ...
    def handle(self, *args, **kwargs):
        ...
        # Clear the existing NBA games in the database
        NBAGame.objects.all().delete()
        self.logger.info("Cleared the NBAGame table in the database.")
