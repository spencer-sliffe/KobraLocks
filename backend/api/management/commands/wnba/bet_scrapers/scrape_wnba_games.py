# backend/api/management/commands/scrape_wnba_games.py
...
import time
from api.models import WNBAGame
import datetime
import pytz
import logging

class Command(BaseCommand):
    help = 'Scrape WNBA games data from ESPNBet'
    ...
    def handle(self, *args, **kwargs):
        ...
        # Clear the existing WNBA games in the database
        WNBAGame.objects.all().delete()
        self.logger.info("Cleared the WNBAGame table in the database.")
        ...
        # URL to scrape
        url = "https://espnbet.com/sport/basketball/organization/united-states/competition/wnba"
        driver.get(url)
