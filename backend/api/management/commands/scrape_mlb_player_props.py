...
import logging
import json
from api.models import MLBGameLinks, MLBGamePlayerProps
from concurrent.futures import ThreadPoolExecutor, as_completed

class Command(BaseCommand):
    help = 'Scrape MLB playerprops data from ESPNBet using stored game IDs'
    ...
    def handle(self, *args, **kwargs):
        ...
        MLBGamePlayerProps.objects.all().delete()
        self.logger.info("Cleared the MLBPlayerProps table in the database.")
    ...
    def scrape_game_page(self, game_id):
        event_url = f"https://espnbet.com/sport/baseball/organization/united-states/competition/mlb/event/{game_id}/section/player_props"
        ...
        try:
            ...
            if len(players_sections) == 0:
                ...
                # Check extracted values before saving
                    ...
                    MLBGamePlayerProps.objects.create(
                        game_id=game_id,
                        game=game_text,
