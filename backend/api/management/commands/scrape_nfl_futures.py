# backend/api/management/commands/scrape_nfl_futures.py
...
import time
from api.models import NFLFutures
import logging
import json

class Command(BaseCommand):
    help = 'Scrape NFL futures data from ESPNBet'
    ...
    def handle(self, *args, **kwargs):
        ...
        # URL to scrape
        url = "https://espnbet.com/sport/football/organization/united-states/competition/nfl/section/futures"
        driver.get(url)
