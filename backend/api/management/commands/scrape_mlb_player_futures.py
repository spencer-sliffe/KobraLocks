# backend/api/management/commands/scrape_mlb_player_futures.py
...
import time
from api.models import MLBPlayerFutures
import logging
import json

class Command(BaseCommand):
    help = 'Scrape MLB player futures data from ESPNBet'
    ...
    def handle(self, *args, **kwargs):
        ...
        MLBPlayerFutures.objects.all().delete()
        self.logger.info("Cleared the MLBFutures table in the database.")
        ...
        # URL to scrape
        url = "https://espnbet.com/sport/baseball/organization/united-states/competition/mlb/section/player-awards"
        driver.get(url)
    ...
    def handle_future(self, future):
        try:
            ...
            MLBPlayerFutures.objects.create(
