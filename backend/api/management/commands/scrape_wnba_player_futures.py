# backend/api/management/commands/scrape_wnba_player_futures.py
...
import time
from api.models import WNBAPlayerFutures
import logging
import json

class Command(BaseCommand):
    help = 'Scrape WNBA player futures data from ESPNBet'
    ...
    def handle(self, *args, **kwargs):
        ...
        WNBAPlayerFutures.objects.all().delete()
        ...
        # URL to scrape
        url = "https://espnbet.com/sport/basketball/organization/united-states/competition/wnba/section/player-futures"
        driver.get(url)
    ...
    def handle_future(self, future):
        try:
            ...
            WNBAPlayerFutures.objects.create(
