# backend/api/management/commands/scrape_nba_futures.py
...
import time
from api.models import NBAFutures
import logging
import json

class Command(BaseCommand):
    help = 'Scrape NBA futures data from ESPNBet'
    ...
    def handle(self, *args, **kwargs):
        ...
        # URL to scrape
        url = "https://espnbet.com/sport/basketball/organization/united-states/competition/nba/section/futures"
        driver.get(url)
