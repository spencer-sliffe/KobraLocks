# backend/api/management/commands/scrape_nfl_games.py
...
class Command(BaseCommand):
    help = 'Scrape NFL games data from ESPNBet'
    ...
    def handle(self, *args, **kwargs):
        ...
        # Clear the existing NFL games in the database
        NFLGame.objects.all().delete()
        self.logger.info("Cleared the NFLGame table in the database.")
